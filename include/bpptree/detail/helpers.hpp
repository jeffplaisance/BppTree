...
// Stack unwinding code generated by clang is enormous, so by default a few methods are marked noexcept in order to
// reduce the binary size. If you want to use exceptions with clang, define BPPTREE_DISABLE_EXCEPTIONS to be false.
