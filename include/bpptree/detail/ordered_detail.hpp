...
public:
    ...
    struct LeafNode : public Parent {
        ...
        template <typename F, typename R, typename S, typename... Args>
        void insertOrAssign(Key const& searchVal, F&& finder, R&& doReplace, S&& doSplit, size_t& size, uint64_t& iter, bool rightMost,
                            Args&& ... args) {
